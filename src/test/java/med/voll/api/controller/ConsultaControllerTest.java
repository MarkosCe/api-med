...
class ConsultaControllerTest {
    ...
    @Autowired
    private JacksonTester<DatosRegistroConsulta> registroConsultaJacksonTester;
    ...
    @Test
    @DisplayName("deberia retornar estado http 400 cuando los datos ingresados sean incorrectos")
    @WithMockUser
    ...
    void agendarEscenario2() throws Exception {
        ...
        var response = mockMvc.perform(post("/consultas")
                ...
                .content(registroConsultaJacksonTester.write(
                        new DatosRegistroConsulta(2l, 5l, especialidad, fecha)).getJson()))
